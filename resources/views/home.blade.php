  ...
  <div class="master-slider ms-skin-default" id="masterslider"> 
    ...
    <div class="ms-slide slide-1" data-delay="9">
      ...
      <h3 class="ms-layer text39"
			...
			data-ease="easeOutExpo"
			data-duration="1230"
			data-effect="right(250)"> welcome to hasta</h3>
      ...
      <h3 class="ms-layer text3"
			...
			data-ease="easeOutExpo"
			data-duration="1230"
			data-effect="right(250)"> Lorem ipsum dolor sit amet sit et justo <br/>
        consectetuer adipiscing elit Suspendisse et justo.</h3>
    ...
    <div class="ms-slide slide-2" data-delay="9">
      ...
      <h3 class="ms-layer text3 text-center"
			style="top: 310px;"
			data-type="text"
			data-delay="1500"
			data-ease="easeOutExpo"
			data-duration="1230"
			data-effect="left(250)"> Lorem ipsum dolor sit amet sit et justo <br/>
        consectetuer adipiscing elit Suspendisse et justo.</h3>
    ...
    <div class="ms-slide slide-3" data-delay="9">
      ...
      <h3 class="ms-layer text38 text-center"
			...
			data-ease="easeOutExpo"
			data-duration="1230"
			data-effect="left(250)"> Welcome to Hasta</h3>
        ...
        <div class="col-md-4 col-sm-6">
          <div class="item-holder marginbottom">
            ...
            <div class="text-box-right less-padding-1">
              ...
              <p class="text-white">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Suspendisse et justo. Praesent mattis commodo augue. </p>
            </div>
          </div>
        </div>
        <!--end item-->
      ...
      <div class="row">
        <div class="col-md-5 col-md-offset-7 col-sm-8 col-sm-offset-4 text-inner clearfix align-left">
          <div class="text-box">
            ...
            <div class="clearfix"></div>
            <p class="sub-title-left">Lorem ipsum dolor sit amet <span class="text-red-5">consectetuer adipiscing elit</span> Suspendisse et justo Praesent mattis commodo augue.</p>
            <ul class="iconlist red-5">
              <li><i class="fa fa-arrow-circle-right"></i> Nullam turpis Cras dapibus orci rutrum </li>
              <li><i class="fa fa-arrow-circle-right"></i> Etiam enim Suspendisse imperdiet cursus nisi Maecenas </li>
              <li><i class="fa fa-arrow-circle-right"></i> Sed massa tellus aliquam rhoncus venenatis quis. </li>
            </ul>
            <br/>
            <br/>
    ...
    <div class="container">
      <div class="row">
          ...
          <div class="col-md-6">
            <div class="feature-box70 bmargin">
              ...
              <div class="text-box-right text-left less-padding-1">
                <h4 class="text-white">Graphic Design</h4>
                <p>Lorem ipsum dolor sit amet sit et justo consectetuer elit. </p>
              </div>
            </div>
          </div>
          <!--end item-->
        ...
        <div class="col-md-4 col-sm-12 col-xs-12">
          <h5>Lorem Ipsum is simply dummy text of theprinting and typesetting it sit has the.</h5>
          <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Suspendisse et justo. Praesent.</p>
          <br/>
          <ul class="iconlist dark">
            <li><i class="fa fa-arrow-circle-right"></i> Nullam turpis Cras dapibus orci rutrum </li>
            <li><i class="fa fa-arrow-circle-right"></i> Etiam enim Suspendisse imperdiet cursus nisi.</li>
            <li><i class="fa fa-arrow-circle-right"></i> Sed massa tellus aliquam rhoncus venenatis </li>
          </ul>
          <br>
  ...
  <section class="parallax-section54">
    <div class="section-overlay light bg-opacity-4">
      <div class="container">
        <div class="row">
          <div class="col-md-3">
            <div class="feature-box72 bmargin text-center">
              <h1>6300</h1>
              <div class="divider-line solid dark less-width-8 align-center opacity-2"></div>
              <br/>
              <h3 class="uppercase">LINES OF CODE</h3>
            </div>
          </div>
          <!--end item-->
          ...
          <div class="col-md-3">
            <div class="feature-box72 bmargin text-center">
              ...
              <div class="divider-line solid dark less-width-8 align-center opacity-2"></div>
              <br/>
              <h3 class="uppercase">cups of cofee</h3>
            </div>
          </div>
          <!--end item-->
          ...
          <div class="col-md-3">
            <div class="feature-box72 bmargin text-center active">
              ...
              <div class="divider-line solid dark less-width-8 align-center opacity-2"></div>
              <br/>
              <h3 class="uppercase">Happy Clients</h3>
            </div>
          </div>
          <!--end item-->
          ...
          <div class="col-md-3">
            <div class="feature-box72 bmargin text-center">
              ...
              <div class="divider-line solid dark less-width-8 align-center opacity-2"></div>
              <br/>
              <h3 class="uppercase">Latest Awards</h3>
            </div>
          </div>
          <!--end item--> 
